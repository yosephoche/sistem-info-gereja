                            ...
                            <div class="column-1_3 sc_column_item sc_column_item_1 odd first">
                                <div class="sc_section margin_left_6_4286">
                                    <div class="sc_section_inner">
                                        <h3 class="sc_title sc_title_regular hp1_event_title_1 tpl_light">Next event:</h3>
{{--                                        <h6 class="sc_title sc_title_regular tpl_light font_weight_400">{{$newest_event->name}}</h6>--}}
                                        <span class="sc_title sc_title_regular tpl_light font_weight_400">{{$newest_event->custom_start_date}}</span> -
                                    </div>
                                </div>
                            </div>
                                ...
                                <div id="sc_countdown_1" class="sc_countdown sc_countdown_style_1 aligncenter margin_top_null">
                                    <div class="sc_countdown_inner">
                                        <div class="sc_countdown_item sc_countdown_days">
                                            <h3 class="sc_title sc_title_regular tpl_light font_weight_400">{{$newest_event->name}}</h3>
                                        </div>
                                ...
                                <div class="sc_services_wrap">
                                    <div class="sc_services sc_services_style_services-5 sc_services_type_icons sc_slider_nopagination sc_slider_nocontrols width_100_per" data-interval="5040" data-slides-min-width="250">
                                        ...
                                        <div class="sc_services_descr sc_item_descr">
                                            @if ($about)
                                                {!! \Illuminate\Support\Str::limit($about->description, 400, $end='<a href="/profil">   Read more </a>') !!}
                                            @endif
                                        </div>
                                    ...
                                    <div class="esg-media-cover-wrapper">
                                        ...
                                        <div class="esg-entry-cover esg-fade" data-delay="0">
                                            ...
                                            <div class="esg-center eg-washington-element-0-a esg-falldown" data-delay="0.1">
                                                <a class="eg-washington-element-0 esgbox" href="{{$image->full_path}}">
                                            ...
                                            <div class="esg-center eg-washington-element-3 esg-flipup" data-delay="0.1">{{$image->caption}}</div>
                ...
                <div class="hp1_blogger_section content_wrap">
                    <div id="sc_blogger_1" class="sc_blogger layout_classic_3 template_masonry margin_top_huge margin_bottom_medium sc_blogger_horizontal sc_scroll_controls sc_scroll_controls_type_top sc_scroll_controls_horizontal">
                                                ...
                                                <div class="post_item post_item_classic post_item_classic_3 odd">
                                                    <div class="post_featured">
                                                        ...
                                                        <div class="post_thumb" data-title="Small Group Leader Training">
                                                            <a class="hover_icon hover_icon_link" href="{{ route('blog.detail', ['id'=>$article->id]) }}">
                        ...
                        <div class="sc_blogger_button sc_item_button">
                            <a href="/blog" class="sc_button sc_button_square sc_button_style_filled sc_button_color_style_2 sc_button_size_large">View more</a>
                        </div>
                    </div>
                </div>
                <!-- /Blogger section -->
